...
> Shows how to encrypt and handle multiple values

## Overview

This example demonstrates how to implement **Encrypt Multiple Values** using FHEVM.

| Property | Value |
|----------|-------|
| **Level** | 🟢 Beginner |
| **Category** | encryption |
| **Key** | `encrypt-multiple-values` |

## 📦 Batching Encrypted Inputs

You can encrypt multiple values in a single proof for efficiency:

```mermaid
flowchart LR
    A[addBool] --> D[Single Proof]
    B[add32] --> D
    C[addAddress] --> D
    D --> E[3 Handles + 1 Proof]
```

## 🧠 Key FHE Concepts Used

- `Batched encrypted inputs`
- `Multiple FHE types (ebool, euint32, eaddress)`
- `Single proof for multiple values`

## 📝 Contract Implementation

`contracts/EncryptMultipleValues.sol`
...
npx jobjab-fhevm-examples encrypt-multiple-values ./my-encrypt-multiple-values
