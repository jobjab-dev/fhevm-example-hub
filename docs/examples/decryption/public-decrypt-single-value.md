---
id: public-decrypt-single-value
title: Public Decrypt Single
category: decryption
tags: [decryption, public, intermediate]
...
This example demonstrates how to implement **Public Decrypt Single** using FHEVM.

| Property | Value |
|----------|-------|
| **Level** | 🟡 Intermediate |
| **Category** | decryption |
| **Key** | `public-decrypt-single-value` |

## 🌍 Public Decryption

Make encrypted values publicly visible (e.g., game results, vote tallies):
...
sequenceDiagram
    ...
    C->>G: Request decryption
    G-->>C: Callback with clear value
    A->>C: Read public result
```
...
`contracts/PublicDecryptSingleValue.sol`
...
`test/PublicDecryptSingleValue.ts`
...
npx jobjab-fhevm-examples public-decrypt-single-value ./my-public-decrypt-single-value
