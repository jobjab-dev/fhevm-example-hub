...
| **Level** | 🟡 Intermediate |
| **Category** | decryption |
| **Key** | `user-decrypt-multiple-values` |

## 🧠 Key FHE Concepts Used

- `Batch user decryption`
- `EIP-712 signatures for auth`
- `Multiple handle permissions`
...
npx jobjab-fhevm-examples user-decrypt-multiple-values ./my-user-decrypt-multiple-values
