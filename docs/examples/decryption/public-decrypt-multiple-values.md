---
id: public-decrypt-multiple-values
title: Public Decrypt Multiple
category: decryption
...
This example demonstrates how to implement **Public Decrypt Multiple** using FHEVM.

| Property | Value |
|----------|-------|
| **Level** | 🟡 Intermediate |
| **Category** | decryption |
| **Key** | `public-decrypt-multiple-values` |

## 🧠 Key FHE Concepts Used

- `Batch public decryption`
- `Multiple callbacks`
- `Atomic reveal patterns`

## 📝 Contract Implementation

`contracts/PublicDecryptMultipleValues.sol`
...
`test/PublicDecryptMultipleValues.ts`
...
npx jobjab-fhevm-examples public-decrypt-multiple-values ./my-public-decrypt-multiple-values
